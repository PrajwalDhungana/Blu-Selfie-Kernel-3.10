...
#if 0////lc mike_zhu 20150615   #if def CONFIG_OF
...
#else
 #if 1/// lc mike_zhu 20150615//#ifndef CONFIG_MTK_SPEAKER
#ifdef  AW8736_MODE_CTRL
...
#define SPK_WARM_UP_TIME        (25) //unit is ms
    ...
    if (enable)
    {
        printk("mt_soc_codec_63xx.c Ext_Speaker_Amp_Change ON+ \n");
#if 1////lc mike_zhu 20150615  #ifndef CONFIG_MTK_SPEAKER
        printk("mt_soc_codec_63xx.c Ext_Speaker_Amp_Change ON set GPIO \n");
    ...
    {
        printk("mt_soc_codec_63xx.c Ext_Speaker_Amp_Change OFF+ \n");
#if 1////lc mike_zhu 20150615  #ifndef CONFIG_MTK_SPEAKER
        //mt_set_gpio_mode(GPIO_EXT_SPKAMP_EN_PIN, GPIO_MODE_00); //GPIO117: DPI_D3, mode 0
        mt_set_gpio_dir(GPIO_EXT_SPKAMP_EN_PIN, GPIO_DIR_OUT); // output
