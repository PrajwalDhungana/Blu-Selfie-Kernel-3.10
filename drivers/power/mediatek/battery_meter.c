...
printk("battery_meter.c : gFG_capacity_by_v=%d g_rtc_fg_soc=%d gFG_capacity_by_v_init=%d\n",gFG_capacity_by_v,g_rtc_fg_soc,gFG_capacity_by_v_init);
...
printk("battery_meter.c : gFG_capacity_by_v=%d g_rtc_fg_soc=%d gFG_capacity_by_v_init=%d ,type=%d\n",gFG_capacity_by_v,g_rtc_fg_soc,gFG_capacity_by_v_init,type);
