...
#define MAX_CHARGE_TEMPERATURE  58	//modify by hzy
#define MAX_CHARGE_TEMPERATURE_MINUS_X_DEGREE	51//54////53///52//51//50//55	//modify by hzy
#if 1//lc mike_zhu 20150616 BAT_LOW_TEMP_PROTECT_ENABLE open
#define MIN_CHARGE_TEMPERATURE  ( -30)
#define MIN_CHARGE_TEMPERATURE_PLUS_X_DEGREE	 (-20)
#else
...
#if 1//lc mike_zhu 20150611
#define V_CC2TOPOFF_THRES		4310  
#define RECHARGING_VOLTAGE      4320
#define CHARGING_FULL_CURRENT    60	//72 mA
#else
...
#if 0///lc mike_zhu 20150708 for charge
#define USB_CHARGER_CURRENT_UNCONFIGURED	         CHARGE_CURRENT_50_00_MA	// 178.5mA
#define USB_CHARGER_CURRENT_CONFIGURED		CHARGE_CURRENT_125_00_MA//// 446mA

#define USB_CHARGER_CURRENT					CHARGE_CURRENT_125_00_MA	// 446mA
#define AC_CHARGER_CURRENT					CHARGE_CURRENT_200_00_MA///714mA
#define NON_STD_AC_CHARGER_CURRENT			CHARGE_CURRENT_200_00_MA///714mA
#define CHARGING_HOST_CHARGER_CURRENT       CHARGE_CURRENT_125_00_MA	// 446mA
#define APPLE_0_5A_CHARGER_CURRENT         CHARGE_CURRENT_125_00_MA	// 446mA
#define APPLE_1_0A_CHARGER_CURRENT         CHARGE_CURRENT_150_00_MA///535mA
#define APPLE_2_1A_CHARGER_CURRENT         CHARGE_CURRENT_225_00_MA///714mA
#else
...
#define AC_CHARGER_CURRENT					CHARGE_CURRENT_700_00_MA///lc mike_zhu 20150604
...
//lc mike_zhu 20150529
#define BAT_OVP_PROTECT_ENABLE  
/* Tracking TIME */
#if 1//mike_zhu 20150629
#define ONEHUNDRED_PERCENT_TRACKING_TIME		10	// 10 second
#define NPERCENT_TRACKING_TIME	   			30	// 20 second
#define SYNC_TO_REAL_TRACKING_TIME  			50//60	// 60 second
