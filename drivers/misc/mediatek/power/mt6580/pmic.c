...
void PMIC_INIT_SETTING_V1(void)
{
        ...
        ret = pmic_config_interface(0x2E,0x1,0x1,7); // [7:7]: RG_ULC_DET_EN; Tim,Zax
         ret=pmic_config_interface(0x40,0x0,0x1,0);   //lc mike_zhu 20150526 for FCHR key
        ret=pmic_config_interface(0x40,0x0,0x1,1);   //lc mike_zhu 20150526 for FCHR key
	ret=pmic_config_interface(0x40,0x1,0x1,2);	//lc mike_zhu 20150526 for FCHR key
	ret=pmic_config_interface(0x16c,0x1,0x1,3);	//lc mike_zhu 20150526 for FCHR key
