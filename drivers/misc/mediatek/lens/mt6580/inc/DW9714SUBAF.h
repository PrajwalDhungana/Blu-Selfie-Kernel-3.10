#ifndef _DW9714SUBAF_H
#define _DW9714SUBAF_H

#include <linux/ioctl.h>
/* #include "kd_imgsensor.h" */

#define DW9714SUBAF_MAGIC 'A'
...
#define DW9714SUBAFIOC_G_MOTORINFO _IOR(DW9714SUBAF_MAGIC, 0, stDW9714SUBAF_MotorInfo)

#define DW9714SUBAFIOC_T_MOVETO _IOW(DW9714SUBAF_MAGIC, 1, u32)

#define DW9714SUBAFIOC_T_SETINFPOS _IOW(DW9714SUBAF_MAGIC, 2, u32)

#define DW9714SUBAFIOC_T_SETMACROPOS _IOW(DW9714SUBAF_MAGIC, 3, u32)
#ifdef LensdrvCM3
#define DW9714SUBAFIOC_G_MOTORMETAINFO _IOR(DW9714SUBAF_MAGIC, 4, stDW9714SUBAF_MotorMETAInfo)
#endif
