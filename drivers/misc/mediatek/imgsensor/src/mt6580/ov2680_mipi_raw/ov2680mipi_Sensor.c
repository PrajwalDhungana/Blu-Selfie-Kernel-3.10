...
#define LOG_INF(format, args...) printk(format, ##args); 
...
static void preview_setting(void)
{
	...
	*/
	...
	write_cmos_sensor(0x3820, 0xc4);//c0
	write_cmos_sensor(0x3821, 0x04);//00
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
	...
	s_DEVINFO_ccm->device_module = "O7P2-W6150FHQ";
