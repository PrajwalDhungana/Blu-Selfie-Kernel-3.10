...
/* Camera information */
/////lc mike_zhu 20150708 for   Camera information
...
#else
#if 0// ///lc mike_zhu change 20150421 for camera
...
static int __init CAMERA_HW_i2C_init(void)
{
   ...
   /// i2c_register_board_info(SUPPORT_I2C_BUS_NUM2, &i2c_devs2, 1); ///lc mike_zhu change 20150421 for camera
...
static void __exit CAMERA_HW_i2C_exit(void)
{
   ...
   // platform_driver_unregister(&g_stCAMERA_HW_Driver2);///lc mike_zhu change 20150421 for camera
}
