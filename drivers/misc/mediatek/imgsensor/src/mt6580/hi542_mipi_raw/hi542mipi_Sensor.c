...
#define LOG_1 printk("HI542,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
    ...
    .checksum_value = 0xd52d15b0,        //checksum value for Camera Auto Test
...
{
kal_uint16 main_sensor_id;
if (MS2R_Get_CameraMode()==MS2R_MAIN_CAMERA)
{
main_sensor_id =(read_cmos_sensor(0x0004));
LOG_INF(" hi542mipi_Sensor.c---1----  main_sensor_id=0x%x \n",main_sensor_id);
if(main_sensor_id==0x00b1)
{  
main_sensor_id =0xf0f0;
}
else
{ 
main_sensor_id =0x0;
...
{
LOG_INF(" hi542 main sensor      return 0   \n");
    return 0 ;
}
LOG_INF(" hi542mipi_Sensor.c---2----  main_sensor_id=0x%x \n",main_sensor_id);
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
    ...
    if (enable) {
        HI542MIPI_write_cmos_sensor(0x0050,0x1c);
