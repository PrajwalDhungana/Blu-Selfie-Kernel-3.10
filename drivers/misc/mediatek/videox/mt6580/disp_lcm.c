...
//2015-01-23 hzy added for lcm devinfo
...
disp_lcm_handle* disp_lcm_probe(char* plcm_name, LCM_INTERFACE_ID lcm_id)
{
	...
	//2014-01-23 hzy add for lcm info 
#ifdef SLT_DEVINFO_LCM
...
int disp_lcm_init(disp_lcm_handle *plcm, int force)
{
	...
	if(_is_lcm_inited(plcm))
	{
		...
		{
			printk("kernel disp_lcm.c FATAL ERROR, lcm_drv->init is null\n");
			return -1;
		}
	...
	{
		printk("kernel disp_lcm.c plcm is null\n");
		return -1;
	}
}
