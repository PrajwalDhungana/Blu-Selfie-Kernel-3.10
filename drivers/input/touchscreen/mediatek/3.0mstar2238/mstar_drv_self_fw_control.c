...
//        RegSet16BitValue(0x160C, (RegGet16BitValue(0x160C) | 0x01));
        ...
        printk("msg2238  pTpVendorCode[0] = 0x%x , %c \n", pTpVendorCode[0], pTpVendorCode[0]); 
        printk("msg2238  pTpVendorCode[1] = 0x%x , %c \n", pTpVendorCode[1], pTpVendorCode[1]); 
        printk("msg2238  pTpVendorCode[2] = 0x%x , %c \n", pTpVendorCode[2], pTpVendorCode[2]); 
...
static void _DrvFwCtrlMsg22xxEraseEmem(EmemType_e eEmemType)
{
    ...
    {
        printk("msg2238  Erase all block\n");
        ...
        printk("msg2238  Wait erase done flag\n");
    ...
    {
        printk("msg2238  Erase main block\n");
    ...
    {
        printk("msg2238  Erase info block\n");
...
static void _DrvFwCtrlMsg22xxProgramEmem(EmemType_e eEmemType) 
{
    ...
    if (eEmemType == EMEM_MAIN)
    {
        printk("msg2238  Program main block\n");
    ...
    {
        printk("msg2238  Program info block\n");
    ...
    {
        printk("msg2238  eEmemType = %d is not supported for program e-memory.\n", eEmemType);
        return;
    }
    ...
    printk("msg2238  Wait write done flag\n");
...
static u32 _DrvFwCtrlMsg22xxGetFirmwareCrcByHardware(EmemType_e eEmemType) 
{
    ...
    printk("msg2238  Hardware CRC = 0x%x\n", nRetVal);
...
static s32 _DrvFwCtrlParsePacket(u8 *pPacket, u16 nLength, TouchInfo_t *pInfo)
{
    ...
    if (g_IsEnableReportRate == 1)
    {
        if (g_InterruptCount == 4294967296)
        {
            ...
            printk("msg2238  g_InterruptCount reset to 0\n");
        }	
        ...
        if (g_InterruptCount == 0)
        {
            ...
            printk("msg2238  Start time : %lu sec, %lu msec\n", g_StartTime.tv_sec,  g_StartTime.tv_usec); 
        }
        
        g_InterruptCount ++;

        printk("msg2238  g_InterruptCount = %d\n", g_InterruptCount);
    }
#endif //CONFIG_ENABLE_COUNT_REPORT_RATE
    ...
    if (g_GestureWakeupFlag == 1)
    {
        ...
        printk("msg2238  received raw data from touch panel as following:\n");
        printk("msg2238  pPacket[0]=%x \n pPacket[1]=%x pPacket[2]=%x pPacket[3]=%x pPacket[4]=%x pPacket[5]=%x \n", \
        ...
        else if (g_ChipType == CHIP_TYPE_MSG22XX && pPacket[0] == 0xA7 && pPacket[1] == 0x00 && pPacket[2] == 0x80 && pPacket[3] == PACKET_TYPE_GESTURE_DEBUG)
        {
            ...
            {
                nWakeupMode = 0xFE;
                printk("msg2238  gesture debug mode LCM flag = 0\n");
            }
        }
#endif //CONFIG_ENABLE_GESTURE_DEBUG_MODE
        ...
        else if (g_ChipType == CHIP_TYPE_MSG22XX && pPacket[0] == 0xA7 && pPacket[1] == 0x00 && pPacket[2] == 0x80 && pPacket[3] == PACKET_TYPE_GESTURE_INFORMATION)
        {
            ...
            nTmpCount++;
            printk("msg2238  gesture information mode Count = %d\n", nTmpCount);
        }
#endif //CONFIG_ENABLE_GESTURE_INFORMATION_MODE
        ...
        if (bIsCorrectFormat) 
        {
            printk("msg2238  nWakeupMode = 0x%x\n", nWakeupMode);
            ...
            switch (nWakeupMode)
            {
                case 0x58:
                    ...
                    printk("msg2238  Light up screen by DOUBLE_CLICK gesture wakeup.\n");
                ...
                case 0x60:
                    ...
                    printk("msg2238  Light up screen by UP_DIRECT gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, KEY_UP, 0);
                ...
                case 0x61:
                    ...
                    printk("msg2238  Light up screen by DOWN_DIRECT gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, KEY_DOWN, 0);
                ...
                case 0x62:
                    ...
                    printk("msg2238  Light up screen by LEFT_DIRECT gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, KEY_LEFT, 0);
                ...
                case 0x63:
                    ...
                    printk("msg2238  Light up screen by RIGHT_DIRECT gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, KEY_RIGHT, 0);
                ...
                case 0x64:
                    ...
                    printk("msg2238  Light up screen by m_CHARACTER gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, KEY_M, 0);
                ...
                case 0x65:
                    ...
                    printk("msg2238  Light up screen by W_CHARACTER gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, KEY_W, 0);
                ...
                case 0x66:
                    ...
                    printk("msg2238  Light up screen by C_CHARACTER gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, KEY_C, 0);
                ...
                case 0x67:
                    ...
                    printk("msg2238  Light up screen by e_CHARACTER gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, KEY_E, 0);
                ...
                case 0x68:
                    ...
                    printk("msg2238  Light up screen by V_CHARACTER gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, KEY_V, 0);
                ...
                case 0x69:
                    ...
                    printk("msg2238  Light up screen by O_CHARACTER gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, KEY_O, 0);
                ...
                case 0x6A:
                    ...
                    printk("msg2238  Light up screen by S_CHARACTER gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, KEY_S, 0);
                ...
                case 0x6B:
                    ...
                    printk("msg2238  Light up screen by Z_CHARACTER gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, KEY_Z, 0);
                ...
                case 0x6C:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE1_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER1, 0);
                ...
                case 0x6D:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE2_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER2, 0);
                ...
                case 0x6E:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE3_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER3, 0);
                ...
                case 0x6F:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE4_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER4, 0);
                ...
                case 0x70:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE5_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER5, 0);
                ...
                case 0x71:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE6_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER6, 0);
                ...
                case 0x72:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE7_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER7, 0);
                ...
                case 0x73:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE8_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER8, 0);
                ...
                case 0x74:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE9_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER9, 0);
                ...
                case 0x75:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE10_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER10, 0);
                ...
                case 0x76:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE11_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER11, 0);
                ...
                case 0x77:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE12_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER12, 0);
                ...
                case 0x78:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE13_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER13, 0);
                ...
                case 0x79:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE14_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER14, 0);
                ...
                case 0x7A:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE15_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER15, 0);
                ...
                case 0x7B:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE16_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER16, 0);
                ...
                case 0x7C:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE17_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER17, 0);
                ...
                case 0x7D:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE18_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER18, 0);
                ...
                case 0x7E:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE19_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER19, 0);
                ...
                case 0x7F:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE20_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER20, 0);
                ...
                case 0x80:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE21_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER21, 0);
                ...
                case 0x81:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE22_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER22, 0);
                ...
                case 0x82:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE23_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER23, 0);
                ...
                case 0x83:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE24_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER24, 0);
                ...
                case 0x84:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE25_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER25, 0);
                ...
                case 0x85:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE26_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER26, 0);
                ...
                case 0x86:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE27_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER27, 0);
                ...
                case 0x87:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE28_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER28, 0);
                ...
                case 0x88:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE29_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER29, 0);
                ...
                case 0x89:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE30_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER30, 0);
                ...
                case 0x8A:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE31_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER31, 0);
                ...
                case 0x8B:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE32_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER32, 0);
                ...
                case 0x8C:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE33_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER33, 0);
                ...
                case 0x8D:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE34_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER34, 0);
                ...
                case 0x8E:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE35_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER35, 0);
                ...
                case 0x8F:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE36_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER36, 0);
                ...
                case 0x90:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE37_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER37, 0);
                ...
                case 0x91:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE38_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER38, 0);
                ...
                case 0x92:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE39_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER39, 0);
                ...
                case 0x93:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE40_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER40, 0);
                ...
                case 0x94:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE41_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER41, 0);
                ...
                case 0x95:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE42_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER42, 0);
                ...
                case 0x96:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE43_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER43, 0);
                ...
                case 0x97:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE44_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER44, 0);
                ...
                case 0x98:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE45_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER45, 0);
                ...
                case 0x99:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE46_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER46, 0);
                ...
                case 0x9A:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE47_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER47, 0);
                ...
                case 0x9B:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE48_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER48, 0);
                ...
                case 0x9C:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE49_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER49, 0);
                ...
                case 0x9D:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE50_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER50, 0);
                ...
                case 0x9E:
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_RESERVE51_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER51, 0);
				...
				case 0xFF://Gesture Fail
                    ...
                    printk("msg2238  Light up screen by GESTURE_WAKEUP_MODE_FAIL gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER51, 0);
                ...
                default:
                    ...
                    printk("msg2238  Un-supported gesture wakeup mode. Please check your device driver code.\n");
                    break;		
            }

            printk("msg2238  _gGestureWakeupValue[0] = 0x%x\n", _gGestureWakeupValue[0]);
            printk("msg2238  _gGestureWakeupValue[1] = 0x%x\n", _gGestureWakeupValue[1]);
        }
        else
        {
            printk("msg2238  gesture wakeup packet format is incorrect.\n");
        }
		...
		if (g_GestureKObj != NULL && pPacket[3] == PACKET_TYPE_GESTURE_DEBUG)
		{
			...
			printk("msg2238  kobject_uevent_env() nRetVal = %d\n", nRetVal);
...
#endif //CONFIG_ENABLE_FIRMWARE_DATA_LOG
    {
        ...
        printk("msg2238  [x,y]=[%d,%d]\n", nX, nY);
        printk("msg2238  [delta_x,delta_y]=[%d,%d]\n", nDeltaX, nDeltaY);
        ...
        if ((pPacket[1] == 0xFF) && (pPacket[2] == 0xFF) && (pPacket[3] == 0xFF) && (pPacket[4] == 0xFF) && (pPacket[6] == 0xFF))
        {
            ...
            {   /* 0x00 is key up, 0xff is touch screen up */
#ifdef CONFIG_ENABLE_PROXIMITY_DETECTION
#if defined(CONFIG_TOUCH_DRIVER_RUN_ON_SPRD_PLATFORM) || defined(CONFIG_TOUCH_DRIVER_RUN_ON_QCOM_PLATFORM)
                printk("msg2238  g_EnableTpProximity = %d, pPacket[5] = 0x%x\n", g_EnableTpProximity, pPacket[5]);
                ...
                if (g_EnableTpProximity && ((pPacket[5] == 0x80) || (pPacket[5] == 0x40)))
                {
                    ...
                    printk("msg2238  g_FaceClosingTp = %d\n", g_FaceClosingTp);
                ...
                if (g_EnableTpProximity && ((pPacket[5] == 0x80) || (pPacket[5] == 0x40)))
                {
                    ...
                    {
                        printk("msg2238  call hwmsen_get_interrupt_data() failed = %d\n", nErr);
                    }
                ...
                /* 0x00 is key up, 0xff is touch screen up */
                printk("msg2238  touch key down pPacket[5]=%d\n", pPacket[5]);
                ...
                {
                    printk("msg2238  multi-key is pressed.\n");
...
//            if ((nDeltaX == 0) && (nDeltaY == 0))
    ...
    {
        printk("msg2238  pPacket[0]=0x%x, pPacket[7]=0x%x, nCheckSum=0x%x\n", pPacket[0], pPacket[7], nCheckSum);
...
static void _DrvFwCtrlStoreFirmwareData(u8 *pBuf, u32 nSize)
{
    ...
    printk("msg2238  *** g_FwDataCount = %d ***\n", g_FwDataCount);

    if (pBuf != NULL)
    {
        printk("msg2238  *** buf[0] = %c ***\n", pBuf[0]);
    }
}
...
static s32 _DrvFwCtrlMsg22xxUpdateFirmwareBySwId(void) 
{
    ...
    printk("msg2238  _gIsUpdateInfoBlockFirst = %d, _gIsUpdateFirmware = 0x%x\n", _gIsUpdateInfoBlockFirst, _gIsUpdateFirmware);
    ...
    if (_gIsUpdateInfoBlockFirst == 1)
    {
        if ((_gIsUpdateFirmware & 0x10) == 0x10)
        {
            ...
            printk("msg2238  nCrcInfoA = 0x%x, nCrcInfoB = 0x%x\n", nCrcInfoA, nCrcInfoB);
            ...
            if (nCrcInfoA == nCrcInfoB)
            {
                ...
                printk("msg2238  nCrcMainA = 0x%x, nCrcMainB = 0x%x\n", nCrcMainA, nCrcMainB);
...
void _DrvFwCtrlMsg22xxCheckFirmwareUpdateBySwId(void)
{
    ...
    printk("msg2238  nCrcMainA=0x%x, nCrcInfoA=0x%x, nCrcMainB=0x%x, nCrcInfoB=0x%x\n", nCrcMainA, nCrcInfoA, nCrcMainB, nCrcInfoB);
    ...
    if (nCrcMainA == nCrcMainB && nCrcInfoA == nCrcInfoB) // Case 1. Main Block:OK, Info Block:OK
    {
        ...
        {
            printk("msg2238  eSwId = 0x%x is an undefined SW ID.\n", eSwId);
        ...
        printk("msg2238  eSwId=0x%x, nMajor=%d, nMinor=%d, nUpdateBinMajor=%d, nUpdateBinMinor=%d\n", eSwId, nMajor, nMinor, nUpdateBinMajor, nUpdateBinMinor);
        ...
        if (nUpdateBinMinor > nMinor)
        {
            ...
            {
                printk("msg2238  The sw id is invalid.\n");
                printk("msg2238  Go to normal boot up process.\n");
            }
        }
        else
        {
            printk("msg2238  The update bin version is older than or equal to the current firmware version on e-flash.\n");
            printk("msg2238  Go to normal boot up process.\n");
        }
    }
    ...
    {
        printk("msg2238  Main block and Info block are broken.\n");
        printk("msg2238  Go to normal boot up process.\n");
    }
...
//        DBG("*** reg(0x3C, 0xE4) = 0x%x ***\n", nRegData); // add for debug
    ...
    printk("msg2238  Main Block CRC = 0x%x\n", nRetVal);
...
static s32 _DrvFwCtrlMsg21xxaUpdateFirmwareBySwId(u8 szFwData[][1024], EmemType_e eEmemType) 
{
    ...
    for (i = 0; i < nCalculateCrcSize; i ++)
    {
        ...
        if (i < 32)   // emem_main
        {
            if (i == 31)
            {
                ...
                printk("msg2238  nCrcTemp=%x\n", nCrcTemp); // add for debug

                for (j = 0; j < 4; j ++)
                {
                    szFwData[i][1023-j] = ((nCrcTemp>>(8*j)) & 0xFF);

                    printk("msg2238  ((nCrcTemp>>(8*%d)) & 0xFF)=%x\n", j, ((nCrcTemp>>(8*j)) & 0xFF)); // add for debug
                    printk("msg2238  Update main clock crc32 into bin buffer szFwData[%d][%d]=%x\n", i, (1020+j), szFwData[i][1020+j]);
                }
            }
            else
            {
    ...
    printk("msg2238  nCrcMain=0x%x, nCrcInfo=0x%x, nCrcMainTp=0x%x, nCrcInfoTp=0x%x\n", nCrcMain, nCrcInfo, nCrcMainTp, nCrcInfoTp);
...
void _DrvFwCtrlMsg21xxaCheckFirmwareUpdateBySwId(void) 
{
    ...
    if (nCrcMainA == nCrcMainB) 
    {
        ...
        printk("msg2238  Check firmware integrity success\n");
        printk("msg2238  eMainSwId=0x%x, eInfoSwId=0x%x\n", eMainSwId, eInfoSwId);
    ...
    else
    {
        ...
        printk("msg2238  Check firmware integrity failed\n");
        printk("msg2238  eSwId=0x%x\n", eSwId);
...
static void _DrvFwCtrlUpdateFirmwareBySwIdDoWork(struct work_struct *pWork)
{
    ...
    {
        printk("msg2238  This chip type (%d) does not support update firmware by sw id\n", g_ChipType);
    ...
    printk("msg2238  *** update firmware by sw id result = %d ***\n", nRetVal);
    
    if (nRetVal == 0)
    {
        printk("msg2238  update firmware by sw id success\n");
    ...
    else //nRetVal == -1
    {
        ...
        {
            printk("msg2238  _gUpdateRetryCount = %d\n", _gUpdateRetryCount);
            queue_work(_gUpdateFirmwareBySwIdWorkQueue, &_gUpdateFirmwareBySwIdWork);
        }
        else
        {
            printk("msg2238  update firmware by sw id failed\n");
...
static s32 _DrvFwCtrlMsg22xxUpdateFirmware(u8 szFwData[][1024], EmemType_e eEmemType)
{
    ...
    {
        printk("msg2238  Program main block start\n");
        ...
        printk("msg2238  Wait main block write done flag\n");
        ...
        printk("msg2238  Program main block end\n");
    }
    
    if (eEmemType == EMEM_ALL || eEmemType == EMEM_INFO) // 512 Byte
    {
        printk("msg2238  Program info block start\n");
        ...
        printk("msg2238  Wait info block write done flag\n");
        ...
        printk("msg2238  Program info block end\n");
    }
    ...
    if (eEmemType == EMEM_ALL || eEmemType == EMEM_MAIN)
    {
        ...
        // CRC Main from TP
        printk("msg2238  Get Main CRC from TP\n");

        nCrcMainTp = _DrvFwCtrlMsg22xxGetFirmwareCrcByHardware(EMEM_MAIN);
    
        printk("msg2238  nCrcMain=0x%x, nCrcMainTp=0x%x\n", nCrcMain, nCrcMainTp);
    }
    ...
    if (eEmemType == EMEM_ALL || eEmemType == EMEM_INFO)
    {
        ...
        // CRC Info from TP
        printk("msg2238  Get Info CRC from TP\n");

        nCrcInfoTp = _DrvFwCtrlMsg22xxGetFirmwareCrcByHardware(EMEM_INFO);

        printk("msg2238  nCrcInfo=0x%x, nCrcInfoTp=0x%x\n", nCrcInfo, nCrcInfoTp);
    }
...
static s32 _DrvFwCtrlUpdateFirmwareCash(u8 szFwData[][1024])
{
    ...
    printk("msg2238 _DrvFwCtrlUpdateFirmwareCash g_ChipType = 0x%x\n", g_ChipType);
...
//        nChipType = RegGet16BitValue(0x1ECC) & 0xFF;
        ...
        printk("msg2238  chip version = 0x%x\n", nChipVersion);
    ...
    {
        printk("msg2238  Can not update firmware. Catch-2 is no need to be maintained now.\n");
        g_FwDataCount = 0; // Reset g_FwDataCount to 0 after update firmware
...
static s32 _DrvFwCtrlUpdateFirmwareBySdCard(const char *pFilePath)
{
    ...
    if (IS_ERR(pfile))
    {
        printk("msg2238  Error occured while opening file %s.\n", pFilePath);
        return -1;
    }
    ...
    printk("msg2238  eVendorId = 0x%x, eSwId = 0x%x\n", eVendorId, eSwId);
    ...
    if (eSwId == eVendorId)
    {
        if ((g_ChipType == CHIP_TYPE_MSG21XXA && fsize == 33792/* 33KB */) || (g_ChipType == CHIP_TYPE_MSG22XX && fsize == 49664/* 48.5KB */))
        {
       	...
       	{
            printk("msg2238  The file size of the update firmware bin file is not supported, fsize = %d\n", fsize);
            nRetVal = -1;
        }
    }
    else 
    {
        printk("msg2238  The vendor id of the update firmware bin file is different from the vendor id on e-flash.\n");
        nRetVal = -1;
    }
...
void DrvFwCtrlOptimizeCurrentConsumption(void)
{
    ...
    printk("msg2238  g_ChipType = 0x%x\n", g_ChipType);
...
u8 DrvFwCtrlGetChipType(void)
{
    ...
    if (rc < 0)
    {
        printk("msg2238  *** DbBusEnterSerialDebugMode() failed, rc = %d ***\n", rc);
        return nChipType;
    }
    DbBusStopMCU();
    DbBusIICUseBus();
...
s32 DrvFwCtrlUpdateFirmwareBySdCard(const char *pFilePath)
{
    ...
    {
        printk("msg2238  This chip type (%d) does not support update firmware by sd card\n", g_ChipType);
    }
...
//    DBG("*** %s() ***\n", __func__);
    ...
    {
        printk("msg2238  Skip finger touch for handling get firmware info or change firmware mode\n");
        return;
    }
    ...
    if (g_FirmwareMode == FIRMWARE_MODE_DEMO_MODE)
    {
        printk("msg2238  FIRMWARE_MODE_DEMO_MODE\n");
    ...
    {
        printk("msg2238  FIRMWARE_MODE_DEBUG_MODE\n");

        if (g_FirmwareInfo.nLogModePacketHeader != 0x62)
        {
            printk("msg2238  WRONG DEBUG MODE HEADER : 0x%x\n", g_FirmwareInfo.nLogModePacketHeader);
            goto End;		
        }
    ...
    {
        printk("msg2238  FIRMWARE_MODE_RAW_DATA_MODE\n");

        if (g_FirmwareInfo.nLogModePacketHeader != 0x62)
        {
            printk("msg2238  WRONG RAW DATA MODE HEADER : 0x%x\n", g_FirmwareInfo.nLogModePacketHeader);
            goto End;		
        }
    ...
    {
        printk("msg2238  WRONG FIRMWARE MODE : 0x%x\n", g_FirmwareMode);
        goto End;		
    }
#else
    printk("msg2238  FIRMWARE_MODE_DEMO_MODE\n");
    ...
    {
        printk("msg2238  Set gesture debug mode packet length, g_ChipType=%d\n", g_ChipType);
        ...
        {
            printk("msg2238  This chip type does not support gesture debug mode.\n");
            goto End;		
        }
    }
    else if (g_GestureWakeupFlag == 1)
    {
        printk("msg2238  Set gesture wakeup packet length, g_ChipType=%d\n", g_ChipType);
        ...
        {
            printk("msg2238  This chip type does not support gesture wakeup.\n");
            goto End;		
        }
	}
    ...
    if (0 == _DrvFwCtrlParsePacket(pPacket, nReportPacketLength, &tInfo))
    {
        ...
        if ((tInfo.nFingerNum) == 0)   //touch end
        {
            if (nLastKeyCode != 0)
            {
                printk("msg2238  key touch released\n");
        ...
        else //touch on screen
        {
            if (tInfo.nTouchKeyCode != 0)
            {
                ...
                {
                    printk("msg2238  key touch pressed\n");
                    printk("msg2238  nTouchKeyCode = %d, nLastKeyCode = %d\n", nTouchKeyCode, nLastKeyCode);
            ...
            {
                printk("msg2238  tInfo->nFingerNum = %d...............\n", tInfo.nFingerNum);
        ...
        if (g_IsEnableReportRate == 1)
        {
            if (g_ValidTouchCount == 4294967296)
            {
                ...
                printk("msg2238  g_ValidTouchCount reset to 0\n");
            } 	

            g_ValidTouchCount ++;

            printk("msg2238  g_ValidTouchCount = %d\n", g_ValidTouchCount);
        }
#endif //CONFIG_ENABLE_COUNT_REPORT_RATE
    }
...
void DrvFwCtrlOpenGestureWakeup(u32 *pMode)
{
    ...
    printk("msg2238  wakeup mode 0 = 0x%x\n", pMode[0]);
    printk("msg2238  wakeup mode 1 = 0x%x\n", pMode[1]);
    ...
    while (i < 5)
    {
        ...
        if (rc > 0)
        {
            printk("msg2238  Enable gesture wakeup index 0 success\n");
            break;
        }
    ...
    if (i == 5)
    {
        printk("msg2238  Enable gesture wakeup index 0 failed\n");
    }
    ...
    while (i < 5)
    {
        ...
        if (rc > 0)
        {
            printk("msg2238  Enable gesture wakeup index 1 success\n");
            break;
        }
    ...
    if (i == 5)
    {
        printk("msg2238  Enable gesture wakeup index 1 failed\n");
    }
    ...
    while (i < 5)
    {
        ...
        if (rc > 0)
        {
            printk("msg2238  Enable gesture wakeup index 2 success\n");
            break;
        }
    ...
    if (i == 5)
    {
        printk("msg2238  Enable gesture wakeup index 2 failed\n");
    }
    ...
    while (i < 5)
    {
        ...
        if (rc > 0)
        {
            printk("msg2238  Enable gesture wakeup index 3 success\n");
            break;
        }
    ...
    if (i == 5)
    {
        printk("msg2238  Enable gesture wakeup index 3 failed\n");
    }
    ...
    while (i < 5)
    {
        ...
        if (rc > 0)
        {
            printk("msg2238  Enable gesture wakeup success\n");
            break;
        }
    ...
    if (i == 5)
    {
        printk("msg2238  Enable gesture wakeup failed\n");
    }
...
void DrvFwCtrlOpenGestureDebugMode(u8 nGestureFlag)
{
    ...
    printk("msg2238  Gesture Flag = 0x%x\n", nGestureFlag);
    ...
    if (rc < 0)
    {
        printk("msg2238  Enable gesture debug mode failed\n");
    }
    else
    {
        printk("msg2238  Enable gesture debug mode success\n");
    }
...
void DrvFwCtrlCloseGestureDebugMode(void)
{
    ...
    if (rc < 0)
    {
        printk("msg2238  Disable gesture debug mode failed\n");
    }
    else
    {
        printk("msg2238  Disable gesture debug mode success\n");
    }
...
u16 DrvFwCtrlChangeFirmwareMode(u16 nMode)
{
    ...
    while (i < 5)
    {
        ...
        if (rc > 0)
        {
            printk("msg2238  Change firmware mode success\n");
            break;
        }
    ...
    if (i == 5)
    {
        printk("msg2238  Change firmware mode failed, rc = %d\n", rc);
    }
...
void DrvFwCtrlGetFirmwareInfo(FirmwareInfo_t *pInfo)
{
    ...
    while (i < 5)
    {
        ...
        if (rc > 0)
        {
            printk("msg2238  Get firmware info IicWriteData() success\n");
        }
        mdelay(20);
        rc = IicReadData(SLAVE_I2C_ID_DWI2C, &szDbBusRxData[0], 8);
        if (rc > 0)
        {
            printk("msg2238  Get firmware info IicReadData() success\n");
            break;
        }
    ...
    if (i == 5)
    {
        printk("msg2238  Get firmware info failed, rc = %d\n", rc);
    }
    ...
    printk("msg2238  pInfo->nFirmwareMode=0x%x, pInfo->nLogModePacketHeader=0x%x, pInfo->nLogModePacketLength=%d, pInfo->nIsCanChangeFirmwareMode=%d\n", pInfo->nFirmwareMode, pInfo->nLogModePacketHeader, pInfo->nLogModePacketLength, pInfo->nIsCanChangeFirmwareMode);
...
void DrvFwCtrlRestoreFirmwareModeToLogDataMode(void)
{
    ...
    if (g_IsSwitchModeByAPK == 1)
    {
        ...
        printk("msg2238  g_FirmwareMode = 0x%x, tInfo.nFirmwareMode = 0x%x\n", g_FirmwareMode, tInfo.nFirmwareMode);
        ...
        {
            printk("msg2238  firmware mode is not restored\n");
        }
    }
}
#endif //CONFIG_ENABLE_FIRMWARE_DATA_LOG
...
s32 DrvFwCtrlEnableProximity(void)
{
    ...
    {
        printk("msg2238  *** Un-recognized chip type = 0x%x ***\n", g_ChipType);
        return -1;
    }
    ...
    if (rc > 0)
    {
        printk("msg2238  Enable proximity detection success\n");
    }
    else
    {
        printk("msg2238  Enable proximity detection failed\n");
    }
...
s32 DrvFwCtrlDisableProximity(void)
{
    ...
    if (rc > 0)
    {
        printk("msg2238  Disable proximity detection success\n");
    }
    else
    {
        printk("msg2238  Disable proximity detection failed\n");
    }
