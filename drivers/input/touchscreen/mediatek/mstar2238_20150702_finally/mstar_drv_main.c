...
static MSG2238_CTP_MODULE msg2238_ctp_module_name = msg2238_ctp_dj_kuantie;	//add by lizhiye
...
s32 DrvMainTouchDeviceInitialize(void)
{
    ...
    g_ChipType = DrvIcFwLyrGetChipType(); //
  // printk("swf55 drv_main.c line=%d,g_ChipType=%d,  %s() \n",__LINE__,g_ChipType,__func__);
...
#if defined(CONFIG_ENABLE_CHIP_MSG21XXA) || defined(CONFIG_ENABLE_CHIP_MSG22XX)
        g_FirmwareMode = g_FirmwareInfo.nFirmwareMode;
       // printk("swf55 drv_main.c line=%d \n",__LINE__);
#endif //CONFIG_ENABLE_CHIP_MSG21XXA || CONFIG_ENABLE_CHIP_MSG22XX
#endif //CONFIG_ENABLE_FIRMWARE_DATA_LOG
...
///lc mike_zhu 20150708 for tp info
 #if 0///def SLT_DEVINFO_CTP
 #ifdef LCT_ADD_TP_VERSION
	...
	switch(msg2238_ctp_module_name)
	{
		...
		case 2: 
			devinfo_ctp_regchar("msg2238", "TXD", CFG_VER_buff, DEVINFO_USED);
		break;
